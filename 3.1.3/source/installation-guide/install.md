...
|  Command Description    |               Bionic Commands         |
|-------------------------|---------------------------------------|
...
For Ubuntu18 run the following commands: 

```
# /usr/sbin/gluu-serverd-3.1.4 enable
# /usr/sbin/gluu-serverd-3.1.4 start
# /usr/sbin/gluu-serverd-3.1.4 login
```
